                ...
                <div class="navbar navbar-inverse" role="banner">
                    <nav class="collapse navbar-collapse bs-navbar-collapse navbar-left" role="navigation">
                      <ul class="nav navbar-nav">
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="fas fa-chart-bar" aria-hidden="true"></i>&nbsp;Quản lý chấm công<b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <li><a href="chamcongdonvi">Chấm công đơn vị</a></li>
                            <li><a href="thongkechamcong">Thống kê chấm công</a></li>
                            <li><a href="thongkedonvi">Thống kê đơn vị</a></li>
                          </ul>
                        </li>
                      </ul>
                       <ul class="nav navbar-nav">
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="fas fa-calendar-check"></i>Quản lý sự kiện<b class="caret"></b></a>
                          <ul class="dropdown-menu">
                      ...
                      <ul class="nav navbar-nav">
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="fa fa-th-large"></i>&nbsp;Danh mục<b class="caret"></b></a>
                          <ul class="dropdown-menu ">
                            <li><a href="taikhoan">Tài khoản</a></li>
                            <li><a href="canbo">Cán bộ</a></li>
                            <li><a href="chucvu">Chức vụ</a></li>
                            <li><a href="donvi">Đơn vị</a></li>
                            <li><a href="loaibienche">Loại biên chế</a></li>
                          </ul>
                        </li>
                      </ul>
                    </nav>
